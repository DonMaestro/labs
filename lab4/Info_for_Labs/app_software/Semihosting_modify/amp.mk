...
# Files
SYS_FILE_SOF			:= "/home/maestro/Documents/KPI/mag1/SOC/lab4/Info_for_Labs/output_files/comp_arm.sof"
...
COMPILE: semihosting_example.srec

semihosting_example.srec: semihosting_example.axf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@

semihosting_example.axf: $(OBJS)
	$(RM) $@
	$(CC) $(OBJS) $(LDFLAGS) -o $@
...
CLEAN: 
	$(RM) semihosting_example.srec semihosting_example.axf $(OBJS)
